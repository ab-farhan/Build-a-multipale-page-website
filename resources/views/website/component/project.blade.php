        ...
        <div id="one"  class="owl-carousel mb-4 owl-theme">
            ...
            <div class="item m-1 card">
                <div class="text-center">
                    <img class="w-100" src="{{ asset('website/'.$data->project_img) }}" alt="Card image cap">
                    <h5 class="service-card-title mt-4">{{$data->project_name}}</h5>
                    <h6 class="service-card-subTitle p-0 m-0">{{$data->project_sort_des}}</h6>
                    <a href="{{url($data->project_link)}}" class="normal-btn-outline mt-2 mb-4 btn">বিস্তারিত</a>
                </div>
            </div>
            @endforeach
