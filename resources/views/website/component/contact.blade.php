<div id="Contact" class="container-fluid section-marginTop parallax text-center" style="background-image:{{asset('/website/images/banner.jpg;')}} ">
    <div class="row">
        ...
        <div class="col-md-4 contact-form mb-5 pb-5">
